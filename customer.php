 <?php 
    ...
    $con = mysqli_connect('localhost', 'root', '', 'db_event');
        ...
        $sqlTable = "SELECT id, name, email, contact FROM users WHERE role = 'Customer'";
...
<h1 class="text-center">Registered Customers Information</h1>
<br>
...
<table id="example" class="table table-striped table-hover display compact " style="width:100%">
    ...
    <form action="customer.php" method="POST">
        ...
        <form action="customer.php" method="POST" class="delete-form">
                            <input type="hidden" name="idNum" value="<?php echo $person['id']; ?>" />
